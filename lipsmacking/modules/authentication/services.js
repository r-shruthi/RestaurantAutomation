    ...
    function (Base64, $http, $cookieStore, $rootScope, $timeout) {
        ...
        service.Login = function (username, password, callback) {
            ...
            /* Dummy authentication for testing, uses $timeout to simulate api call
             ----------------------------------------------*/
            // $timeout(function(){
            //     var response = { success: username === 'cust' && password === 'cust' };
            //     if(!response.success) {
        ...
        $http.get('http://localhost:3000/employees').then(function(r) { 
         ...
         for (var i in users) {
            if (users[i].username === username && users[i].password === password){
                console.log("success");
                var response = { success: true, userinfo: users[i] };
                break;
            }
   ...
   //      });
      // $timeout($scope.poller(), 1);
            ...
            /* Use this for real authentication
             ----------------------------------------------*/
            // $http.get('localhost:3000/auth', { username: username, password: password })
